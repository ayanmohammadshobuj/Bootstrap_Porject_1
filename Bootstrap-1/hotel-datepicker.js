    ...
    class HotelDatepicker {
        ...
        createDatepickerDomString() {
            ...
            if (this.showTopbar) {
                ...
                if (this.submitButton) {
                    buttonsHtml += '<input type="submit" id="' + this.getSubmitButtonId() + '" class="datepicker__submit-button" value="' + this.lang("submitButton") + '" name="' + this.submitButtonName + '" aria-label="' + this.i18n["aria-submit-button"] + '" onclick="window.location.href=\'#client-form\'">';
                }
                if (buttonsHtml) {
